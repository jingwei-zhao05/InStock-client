      ...
      <section className="inventory">
        ...
        <section className="inventory__heading">
          <div className="inventory__container inventory__container--warehouseWitdh">
            <h4 className="inventory__heading-warehouse">INVENTORYITEM</h4>
            <img
              src={Arrows}
              alt="filter-arrows"
          ...
          <div className="inventory__container inventory__container--addressWitdh">
          ...
          <div className="inventory__container inventory__container--contactNameWitdh">
          ...
          <div className="inventory__container inventory__container--contactInformationWitdh">
